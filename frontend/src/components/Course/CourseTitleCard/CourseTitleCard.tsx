...
function CourseTitleCard({className,section}:{className:string | undefined,section:string | undefined}) {
  return (
    <div className='flex align-content-end flex-wrap card-container justify-content-between mx-auto mt-6 mb-4 border-round lg:w-7' style={{backgroundImage:"url(/assets/img_backtoschool.jpg)",minHeight:"240px"}}>
